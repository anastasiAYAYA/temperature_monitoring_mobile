...
part 'notifications/notification_company_tile.dart';
part 'notifications/alarm_card.dart';
part 'notifications/notification_common_widgets.dart';
...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  List<AlarmModel> _alarmsForLocation(int? locationId) {
    ...
    var list = widget.repo.alarms.where((a) {
      final matchesSensor = locationId == null || sensors.contains(a.sensorId);
            ...
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (alarm.description.isNotEmpty) ...[
                      ...
                      Text(
                        alarm.description,
                        style: TextStyle(fontSize: 12, color: sch.textDim),
                      ),
                    ],
                  ],
                ),
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  hintText: hintText,
                  hintStyle: TextStyle(color: sch.textDim, fontSize: 13),
      ...
      children: [
            ...
            children: [
              Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: () =>
                        setState(() => _adminSelectedLocationId = null),
                    child: Container(
        ...
        if (isMuted)
          Container(
            ...
            child: const Row(
              children: [
                Icon(Icons.notifications_off_outlined, size: 14, color: kRed),
                SizedBox(width: 8),
                Expanded(
                  child: Text(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: _sortOrder == o ? kCyan : Colors.transparent,
                      border: Border.all(
                        color: _sortOrder == o
                            ? kCyan
                            : AppColors.of(context).border,
